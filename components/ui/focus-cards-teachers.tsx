...
export function FocusCardsTeachers({ cards }: { cards: readonly CardType[] }) {
  const [hovered, setHovered] = useState<number | null>(null);

  return (
    <div className="flex justify-center">
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-6 max-w-full mx-auto px-4">
